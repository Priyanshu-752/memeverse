      ...
      <div className="min-h-screen bg-gray-100 py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-8">
            ...
            <h1 className="text-3xl font-bold text-gray-900 mt-4">Rankings - Highest Scores</h1>
            <p className="text-gray-600 mt-2">Displaying all-time best scores for each player</p>
          </div>
